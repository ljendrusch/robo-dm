        ...
        with gr.Tabs():
            with gr.Tab('Elements'):
                ...
                with gr.Tab('Locales'):
                    with gr.Group():
                        ...
                        locales_generate_bt.click(model.generate_locales, inputs=[genre_box, locales_box, locales_generate_num], outputs=locales_box)
            ...
            with gr.Tab('Plot'):
                with gr.Group():
                    ...
                    plot_generate_bt.click(model.generate_plot, inputs=[genre_box, chars_box, species_box, locales_box, plot_box], outputs=plot_box)
            ...
            with gr.Tab('Story'):
                with gr.Group():
                    ...
                    acts_generate_bt.click(model.generate_acts, inputs=[genre_box, plot_box], outputs=acts_box)
